...
<div class="row">
    ...
    <div class="col-lg-3 col-md-4 col-12">
        <button title="Agregar cliente" class="btn btn-success btn-icon-split w-100 position-relative"
            style="padding-left:10px" id="btnClientesAdd">
...
<div class="table-responsive">
    <table id="bstableClientes" class="table table-striped" data-ajax="ajaxGetClientes" data-search="true"
        data-side-pagination="server" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100]"
        ...
        <thead>
            <tr>
                ...
                <th data-field="descuento" data-formatter="formatClientesDescuento" data-sortable="false">Descuento
                </th>
                <th data-field="id" data-formatter="formatClientesOptions" data-align="center" data-sortable="false">
                    Opciones</th>
            </tr>
        </thead>
    </table>
