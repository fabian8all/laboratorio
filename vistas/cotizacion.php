...
<div class="row">
    <div class="col-lg-4 col-md-4 col-12">
        ...
        <div class="card shadow mb-4">
            ...
            <a href="#ClienteCard" class="d-block card-header py-3" data-toggle="collapse" role="button"
                aria-expanded="true" aria-controls="ClienteCard">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <select name="" id="select_status" class="form-control selectpicker"
    ...
    <div class="col-lg-8 col-md-8 col-12">
        ...
        <div class="card shadow mb-4">
            <!-- Card Header - Accordion -->
            <a href="#TotalCard" class="d-block card-header py-3" data-toggle="collapse" role="button"
                aria-expanded="true" aria-controls="TotalCard">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-clipboard-list"></i> Estudios a realizar
                </h6>
            </a>
            <!-- Card Content - Collapse -->
            <div class="collapse show" id="TotalCard">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                <button class="btn btn-success" style="width: 100%;" data-toggle="modal"
                                    data-target="#modAgregarAnticipo"><i class="fas fa-clipboard-list"></i> Solicitar
                                    estudios</button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modAgregarCliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="formAgregar" class="user">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user necesary" id="txtNombres"
                                    placeholder="Nombres*">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user necesary" name="" value=""
                                    placeholder="Genero*">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <input type="number" class="form-control form-control-user necesary" name="" value=""
                                    placeholder="Edad*">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <input type="tel" class="form-control form-control-user necesary" name="" value=""
                                    placeholder="Teléfono*">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <input type="email" class="form-control form-control-user necesary" name="" value=""
...
<!-- MODAL EDITAR -->
<div class="modal fade" id="modAgregarEstudio" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 smallMargin">
                        <form>
                            <div class="input-group">
                                <input type="text" id="txt_busqueda" class="form-control bg-light border-0 small"
                                    style="background-color: white !important" placeholder="Buscar cliente..."
...
<!-- MODAL Anticipo -->
<div class="modal fade" id="modAgregarAnticipo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
